import { commands, type AccentTheme, type OverlayTheme } from "@/bindings";

export type { AccentTheme, OverlayTheme };
...
export const syncThemeFromSettings = async (): Promise<AccentTheme> => {
  try {
    ...
    console.warn("Failed to sync accent theme from settings:", e);
  }
  return "pink";
};
